...
insert into node set node_id=2,name='/router/pku/n1',enable=0,icnflow=200,idnflow=100,ianflow=300,isnflow=0,sum=6600,icnFlowLimit=1000,idnFlowLimit=1000,isnFlowLimit=1000,ianFlowLimit=1000,cpu=91,memory=38;
...
insert into node set node_id=16,name='/router/sz/n5',enable=0,icnflow=200,idnflow=100,ianflow=300,isnflow=0,sum=9688,icnFlowLimit=1000,idnFlowLimit=1000,isnFlowLimit=1000,ianFlowLimit=1000,cpu=91,memory=38;
