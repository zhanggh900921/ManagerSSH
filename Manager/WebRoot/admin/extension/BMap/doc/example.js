            ...
            series : [
                ...
                },
                {
                    ...
                    markLine : {
                        ...
                        data : [
                            [{name:'郑州'},{name:'包头',value:95}],
                            [{name:'郑州'},{name:'昆明',value:90}],
                            [{name:'郑州'},{name:'广州',value:80}],
                            [{name:'郑州'},{name:'郑州',value:70}],
                            [{name:'郑州'},{name:'长春',value:60}],
                            [{name:'郑州'},{name:'重庆',value:50}],
                            [{name:'郑州'},{name:'长沙',value:40}],
                            [{name:'郑州'},{name:'北京',value:30}],
                            [{name:'郑州'},{name:'丹东',value:20}],
                            [{name:'郑州'},{name:'大连',value:10}]
                        ]
                    },
                    markPoint : {
                        symbol:'emptyCircle',
