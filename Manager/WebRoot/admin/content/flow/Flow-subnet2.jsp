...
<table >
	<caption style="font-size: 25px; color: red"><s:property value="network.name"/>逻辑网流量统计(单位 Byte)</caption>
	<thead>
		<tr>
			<td></td>
	...
	<tbody>
		...
		<tr>
			<th scope="row" style="font-size: large; color: blue;"><a href="Subnet-show?subnet.id=<s:property value="#s.id"/>"><s:property value="#s.name"/></a></th>
